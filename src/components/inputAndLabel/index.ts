...
export const inputAndLabel = ({ id, name, type, placeholder, disabled, value, pattern, title, required, inputClassName, labelClassName, inputHandler, focusHandler, blurHandler }: InputAndLabelProps) => {
